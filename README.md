# Kairo's UE5 Style Guide

## Repo Notice

This repo is Kairo's version of the UE5 Style guide by Michael Allar.

## Linking To This Document

Every section of this style guide is numbered for easy reference.
...
| Sound Class             |            | _Class     | Should be put in a folder called SoundClasses |
| Sound Concurrency       |            | _CON       | Should be named after a SoundClass |
| Sound Cue               | SC_        |            |                                  |
| Sound Mix               | Mix_       |            |                                  |
| Sound Wave              | A_         |            |                                  |
...
This means meshes, specific textures & materials should all be placed in their folder together, not in seperate ones.
